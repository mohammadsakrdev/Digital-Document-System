<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Maktab44Form.aspx.cs" Inherits="TadelatApplication.Maktab20Form" %>
            ...
            <table id="pnlGridView" class="ContentTable container-fluid" >
                <tr>
                    <td colspan="3">
                        ...
                        <p class="lead"><b>فرع التجنيد مكتب 44 جند</b></p>
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <p class="lead"><b>الأستاذ/عصام حامد</b></p>
                        <p class="lead"><b>رئيس مكتب 20 جند</b></p>
                    </td>
                    <td colspan="3">
