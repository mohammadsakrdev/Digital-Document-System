<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LagnaForm.aspx.cs" Inherits="TadelatApplication.LagnaForm" %>
            ...
            <table id="pnlGridView" class="ContentTable container-fluid" >
                <tr>
                    <td colspan="3">
                        ...
                        <p class="lead"><b>فرع التجنيد اللجنة الأولى</b></p>
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <p class="lead"><b> أ / ماجدة محمد على</b></p>
                        <p class="lead"><b>رئيس مكتب اللجنة الأولى</b></p>
                    </td>
                    <td colspan="3">
