<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoragaaAlexForm.aspx.cs" Inherits="TadelatApplication.MoragaaAlexForm" %>
...
<body onkeypress="return disableCtrlKeyCombination(event);"
    ...
    <form id="form1" runat="server" style="padding: 10px; padding-top: 60px;
margin-left: 15px; margin-right: 15px;" autocomplete="off" class="container-fluid">
            ...
            <table id="pnlGridView" class="ContentTable container-fluid">
                <tr>
                    <td colspan="3">
                        ...
                        <p class="lead"><b>فرع التجنيد مراجعة الاسكندرية</b></p>
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <p class="lead"><b>ا / نعمة نصر</b></p>
                        <p class="lead"><b>رئيس مكتب مراجعة الاسكندرية</b></p>
                    </td>
                    <td colspan="3">
