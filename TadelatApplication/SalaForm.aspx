<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalaForm.aspx.cs" Inherits="TadelatApplication.DefaultUserForm" %>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container" dir="rtl">
            <div class="navbar-header navbar-right">
                <a class="navbar-brand" href="#"><b>منظومة التعديلات</b></a>
            </div>
            <div class="navbar-header navbar-right">
            ...
            <table id="pnlGridView" class="ContentTable container-fluid">
                <tr>
                    <td colspan="3">
                        ...
                        <p class="lead"><b>فرع صالة الاستقبال</b></p>
                    ...
                    <td colspan="3">
                        <div style="float: left">
                            <img src="Images/logoalex.png" height="75" lang="ar" width="75" />
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <div class="container-fluid" style="text-align: center;">
                            ...
                            <p class="lead"><b>عقيد / صلاح محمود</b></p>
                            <p class="lead"><b>رئيس فرع التجنيد</b></p>
                        </div>
                    </td>
