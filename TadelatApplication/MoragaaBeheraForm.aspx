<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoragaaBeheraForm.aspx.cs" Inherits="TadelatApplication.MoragaaBeheraForm" %>
...
<body onkeypress="return disableCtrlKeyCombination(event);"
    ...
    <form id="form1" runat="server" style="padding: 10px; padding-top: 60px; margin-left: 15px; 
margin-right: 15px;" class="container-fluid" autocomplete="off">
        <div dir="rtl" class="container-fluid">

            <table id="pnlGridView" class="ContentTable container-fluid" >
                <tr>
                    <td colspan="3">
                        <p class="lead"><b>إدارة التجنيد و التعبئة</b></p>
                        <p class="lead"><b>فرع التجنيد مراجعة البحيرة</b></p>
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <p class="lead"><b>الأستاذ/محمد اسماعيل</b></p>
                        <p class="lead"><b>رئيس مكتب مراجعة البحيرة</b></p>
                    </td>
                    <td colspan="3">
                        <div class="container-fluid" style="text-align: center;">
                            <p class="lead"><b>توقيع / </b><b></b></p>
                            <p class="lead"><b>الأستاذ/عادل فؤاد</b></p>
                            <p class="lead"><b>مراقب عام التجنيد</b></p>
                        </div>
                    </td>
                    ...
                    <td colspan="3">
                        <div class="container-fluid" style="text-align: center;">
                            ...
                            <p class="lead"><b>نقيب / سمير خطاب</b></p>
                            <p class="lead"><b>قائد المجمع</b></p>
                        </div>
                    </td>
