<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EntkaForm.aspx.cs" Inherits="TadelatApplication.EntkaForm" %>
            ...
            <table id="pnlGridView" class="ContentTable container-fluid">
                <tr>
                    <td colspan="3">
                        ...
                        <p class="lead"><b>فرع الانتقاء و التوجيه</b></p>
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <p class="lead"><b>مقدم / وليد محمود رمزي</b></p>
                        <p class="lead"><b>قائد طاقم الانتقاء و التوجيه</b></p>
                    </td>
