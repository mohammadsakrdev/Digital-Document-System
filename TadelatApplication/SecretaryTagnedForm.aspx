<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecretaryTagnedForm.aspx.cs" Inherits="TadelatApplication.SecretaryTagnedForm" %>
            ...
            <table id="pnlGridView" class="ContentTable container-fluid">
                <tr>
                    <td colspan="3">
                        ...
                        <p class="lead"><b>فرع التجنيد سكرتارية التجنيد</b></p>
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <p class="lead"><b>ا / محمد جاد</b></p>
                        <p class="lead"><b>سكرتارية التجنيد</b></p>
                    </td>
                    <td colspan="3">
