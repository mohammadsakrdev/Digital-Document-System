...
{
    public partial class DefaultUserForm : System.Web.UI.Page
    {
            ...
            if(ViewState[CurrentTable] != null)
            {
                ...
                if(dtCurrent.Rows.Count > 0)
                {
                    ...
                    for(int i= 0; i < dtCurrent.Rows.Count - 1; i++)
                    {
                        ...
                        dtCurrent.Rows[i][TalabTadelat.TypeID] = ddl.SelectedValue.ToString();
